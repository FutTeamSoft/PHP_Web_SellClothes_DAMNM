    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top shadow-sm rounded">
        ...
        <div class="collapse navbar-collapse text-center" id="navbarResponsive">
            ...
            <ul class="navbar-nav mr-5">
                <li class="nav-item">
                    <a class="nav-link search-icon" data-toggle="collapse" href="#searchBar" aria-expanded="false"
                        aria-controls="searchBar"><i class="fa fa-search"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="cart.php"><i class="fa fa-bag-shopping"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#menuAccount" aria-expanded="false"
                        aria-controls="menuAccount"><i class="fa fa-user"></i></a>
                </li>
            </ul>
            <ul class="navbar-nav mr-5">
                <li class="nav-item">
